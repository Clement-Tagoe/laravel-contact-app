<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ $person->firstname }} {{$person->lastname}}'s Details
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="pt-3">
                                <a class="bg-blue-600 text-white py-2 px-3 rounded-full" href="{{route('person.edit', $person)}}">Edit Person</a>
                            </div>
                        </div>   
                            ...
                            <form action="{{route('task.store')}}" method="POST">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-6 gap-x-6 gap-y-6">
                                    ...
                                    <span class="sm:col-span-6">
                                        ...
                                        <textarea class="block w-full" name="description" id="description" cols="30" rows="2">
                                            {{old('description')}}
                                        </textarea>
                                    </span>
                                </div>
